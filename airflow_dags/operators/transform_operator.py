...
from src.etl.extractor import load_json_data, load_csv_data # Needed to simulate data flow if not using XCom fully
    ...
    def execute(self, context):
        ...
        try:
            if self.transformation_type == 'json_to_df':
                ...
                logger.info(f"Cleaned training data. X shape: {X.shape}, y shape: {y.shape}")
