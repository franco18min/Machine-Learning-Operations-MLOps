...
def run_validation():
    ...
    validator.expect_table_columns_to_match_set(
        column_set=expected_columns, exact_match=False  # Allow extra columns
    )
    ...
    try:
        ...
        validation_definition = context.validation_definitions.add(
            gx.ValidationDefinition(
                name=validation_def_name, data=batch_definition, suite=suite
            )
        )
    ...
    logger.info(
        "Data Docs generated. Open 'gx/uncommitted/data_docs/local_site/index.html' to view."
    )
