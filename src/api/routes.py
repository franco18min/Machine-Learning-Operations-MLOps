...
from src.api.schemas import (
    TopGenresResponse, GamesResponse, TopSpecsResponse, 
    EarlyAccessResponse, SentimentResponse, TopGamesResponse, PredictionResponse
)
...
@router.get('/games_early_access/{juegos_acceso_anticipado}', response_model=EarlyAccessResponse)
...
def top_games(year: str):
    ...
    try:
        ...
        top_games_list = df_year.sort_values(by='metascore', ascending=False).head(5)[['title', 'metascore']].to_dict('records')
